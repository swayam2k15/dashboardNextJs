...
async function fetchLatestInvoices() {
    try {
      ...
      LIMIT 5`;
        const latestInvoices = data.map((invoice1)=>({
                ...invoice1,
                amount: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["formatCurrency"])(invoice1.amount)
            }));
...
async function fetchInvoiceById(id) {
    ...
    `;
        const invoice1 = data.map((invoice1)=>({
                ...invoice1,
